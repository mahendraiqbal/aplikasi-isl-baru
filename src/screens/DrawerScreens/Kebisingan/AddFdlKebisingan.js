...
const AddFdlKebisingan = ({ navigation }) => {
  ...
  const handleModalOption = async (confirmed) => {
    ...
    if (confirmed) {
      ...
      navigation.navigate("FdlKebisinganScreen");
    } else {
      // User selected "Tidak"
  ...
  return (
    <>
              ...
              <>
                ...
                <View style={styles.SectionStyle}>
                  ...
                  <TextInput
                    ...
                    blurOnSubmit={false}
                    value={
                      isEditing ? local.penamaanTambahan : penamaanTambahan
                    }
                    editable={true}
                  />
                </View>
                ...
                <View style={styles.SectionStyle}>
                  ...
                  <SelectDropdown
                    ...
                    defaultValue={isEditing ? local.jen_frek : jenisFrekuensi}
                  />
                </View>
                <View>
                  ...
                  <View style={styles.SectionStyleLocation}>
                    <TextInput
                      ...
                      value={isEditing ? local.posisi : titikKoordinatSampling}
                      underlineColorAndroid="#f000"
                ...
                <View style={styles.SectionRow}>
                  <View style={styles.SectionStyleRow}>
                    ...
                    <View style={styles.SectionRow}>
                      <TextInput
                        ...
                        editable={false}
                        value={isEditing ? local.waktu : jamPengambilan}
                        underlineColorAndroid="#f000"
                  ...
                  <View style={styles.SectionStyleRow}>
                    ...
                    <SelectDropdown
                      ...
                      buttonTextStyle={{ fontSize: 16 }}
                      defaultValue={
                        isEditing ? local.jenisPengujian : jenisPengujian
                      }
                    />
                  </View>
                </View>
                ...
                <View style={styles.SectionRow}>
                  <View style={styles.SectionStyleRow}>
                    ...
                    <SelectDropdown
                      ...
                      defaultValue={
                        isEditing ? local.jenis_durasi : kategoriPengujian
                      }
                    />
                  </View>
                  <View style={styles.SectionStyleRow}>
                ...
                <View style={styles.SectionRow}>
                  <View style={styles.SectionStyleRow}>
                    ...
                    <TextInput
                      ...
                      returnKeyType="next"
                      blurOnSubmit={false}
                      value={isEditing ? local.suhu_udara : suhuUdara}
                    />
                  </View>
                  <View style={styles.SectionStyleRow}>
                    ...
                    <TextInput
                      ...
                      blurOnSubmit={false}
                      value={
                        isEditing ? local.kelembapan_udara : kelembapanUdara
                      }
                    />
                  </View>
                </View>
      ...
      <Modal
        ...
        onBackdropPress={() => handleModalOption(false)}
      >
        <View
        ...
        >
          ...
          >
            <Text>Apakah yakin ingin membatalkan?</Text>
            <View
              style={{
                flexDirection: "row",
            ...
            >
              ...
              <Button
                title="Tidak"
                onPress={() => handleModalOption(false)}
                color="green"
                style={{ borderRadius: 8 }}
              />
            </View>
